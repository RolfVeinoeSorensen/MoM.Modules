...
namespace MoM.Setup
{
    public class Module : IModule
    {
        ...
        {
            routeBuilder.MapRoute("Setup", "Setup/{controller=App}/{action=Index}");
            routeBuilder.MapRoute("SetupPages", "Setup/{controller}/{action}", new { controller = "Setup/Pages", action = "Outlet" });
            routeBuilder.MapRoute("SetupApp", "Setup/{controller}/{action}", new { controller = "setup/App", action = "Index" });
        }
